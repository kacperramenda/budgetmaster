...
abstract class CategoryRepository {
  ...
  Future<List<Category?>> getCategoriesForCurrentMonth(String month, String year);

  // Get category by id for current month and year
  Future<Category?> getCategoryByIdForCurrentMonth(String id, String month, String year);
}
